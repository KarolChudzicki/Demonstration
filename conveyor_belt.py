...
class conveyorBelt:
    ...
    def __init__(self):
        self.client = ModbusSerialClient(port='COM10', baudrate=19200, timeout=1)
    ...
    def start(self):
        self.client.write_register(address=main_control_bit_address, value=(operation_run_or_stop | 0x0001))
